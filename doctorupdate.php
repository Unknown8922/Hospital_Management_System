   <?php
				    ...
				    $var1 ='';
				    $var1 = $_SESSION['name'];
				    $sql = "SELECT * FROM doctors WHERE fullname = '$var1'";
			...
			<div class="card">
				...
				<div class="card-body" >
					...
					<label>Password</label>
						...
						<center> <input type="submit" name="update" value="Update Details" class="btn btn-warning" style="background-color: #9C449D;"></center>
