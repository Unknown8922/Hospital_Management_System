     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
               ...
               <li class="nav-item active">
                    <a class="nav-link" href="http://localhost/RAK_Hospital/adminpanel.php"  style= "color: #5D1E5F;"> Back to Admin Panel</a>
                </li>
...
<div class="container" style="width: 1700px; margin-top:200px";>
	<div class="card">
       <!<img src="images/admin.jpeg" class="card-img-top" width="50px" height="150px">
		...
		<div class="col-md-6">
             <img src="images/all_appointments.png ">
