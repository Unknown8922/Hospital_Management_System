...
<div class="container" style="width: 400px; margin-top:100px";>
	<div class="card">
       <img src="images/doctorlogin.png" class="card-img-top" width="100px" height="150px">
		<div class="card-body">
    <div class="text-center">
        <img src="images/doctorlogin.jpeg" alt="patient login" width="250px" height="200px">
    </div>
	...
	<form class="form-group" action="doctorpanel.php" method="post">
		<label>Email</label>
